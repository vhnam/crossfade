...
- If it does not exist, or no hooks are registered under `hooks.after_plan`,
...
3. **Create quickstart validation guide** → `quickstart.md`:
   - Document runnable validation scenarios that prove the feature works
     end-to-end
   - Include prerequisites, setup commands, test/run commands, and expected
     outcomes
   - Use links or references to contracts and data model details instead of
     duplicating them
   - Do not include full implementation code, model/service/controller bodies,
     migrations, or complete test suites
   - Keep this artifact as a validation/run guide; implementation details belong
...
- Use absolute paths for filesystem operations; use project-relative paths for
...
- [ ] Completion reported to user with branch, plan path, and generated
      artifacts
