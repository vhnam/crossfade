...
This project is indexed by GitNexus as **crossfade** (872 symbols, 1092 relationships, 14 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
